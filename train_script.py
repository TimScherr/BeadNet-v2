...
def main():
    ...
    parser = argparse.ArgumentParser(description='BeadNet training script')
    ...
    parser.add_argument('--method', '-m', default="1x1_dilation", type=str, help='"1x1", "1x1_dilation", "2x2", '
                                                                                 '"2x2_dilation", or "3x3"')
    ...
    # Check method
    if not args.method.lower() in ["1x1", "1x1_dilation", "2x2", "2x2_dilation", "3x3"]:
