""" Graphical user interface of BeadNet """
import json
import numpy as np
import omero.model
import os
...
from src.utils.data_import import DataImportWorker
...
class BeadNetMainWindow(QWidget):
    ...
    def __init__(self, gpu, multi_gpu, omero_settings, model_path, train_path, eval_path, results_path, parent=None):
        ...
        self.annotation_tool_url = f"http://{omero_settings['omero_host']}:{omero_settings['omero-webviewer_port']}"
        ...
        self.inference_models, self.inference_model = [], None
        self.scores_df = None
        ...
        # Window title
        self.setWindowTitle("BeadNet v2")
        ...
        self.omero_login_dialog.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.omero_project_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.omero_dataset_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.omero_file_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.omero_trainset_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.crop_size_512_rbutton.setVisible(False)  # Maybe needed at some point
        self.crop_size_768_rbutton.setVisible(False)
        self.crop_size_1024_rbutton.setVisible(False)
        ...
        self.color_channel_label.setMinimumWidth(60)
        ...
        # Settings box: diameter selection
        self.diameter_selection_label = QLabel('Diameter range [px]:')
        self.diameter_range_1_rbutton = QRadioButton("1 - 4")
        self.diameter_range_2_rbutton = QRadioButton("4 - 8")
        self.diameter_range_3_rbutton = QRadioButton("> 8")
        self.diameter_range_1_rbutton.setChecked(True)
        diameter_group = QButtonGroup(self)
        diameter_group.addButton(self.diameter_range_1_rbutton)
        diameter_group.addButton(self.diameter_range_2_rbutton)
        diameter_group.addButton(self.diameter_range_3_rbutton)
        ...
        self.group_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.device_label.setMinimumWidth(60)
        ...
        self.device_multi_gpu_checkbox.setVisible(False)  # maybe needed later
        ...
        self.train_data.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.train_data_all_frames_checkbox.setChecked(True), self.train_data_all_frames_checkbox.setVisible(False)
        ...
        self.import_data_resolution_checkbox = QCheckBox("Keep resolution")
        self.import_data_resolution_checkbox.setChecked(True)
        ...
        self.select_crops.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.train_settings.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.train_settings_method_1x1_rbutton = QRadioButton('1x1')
        self.train_settings_method_1x1_dilation_rbutton = QRadioButton('1x1 (dilated)')
        self.train_settings_method_2x2_rbutton = QRadioButton('2x2')
        self.train_settings_method_2x2_dilation_rbutton = QRadioButton('2x2 (dilated)')
        self.train_settings_method_3x3_rbutton = QRadioButton('3x3')
        self.train_settings_method_1x1_dilation_rbutton.setChecked(True)
        train_method_group = QButtonGroup(self)
        train_method_group.addButton(self.train_settings_method_1x1_rbutton)
        train_method_group.addButton(self.train_settings_method_1x1_dilation_rbutton)
        train_method_group.addButton(self.train_settings_method_2x2_rbutton)
        train_method_group.addButton(self.train_settings_method_2x2_dilation_rbutton)
        train_method_group.addButton(self.train_settings_method_3x3_rbutton)
        ...
        self.evaluation_menu.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.evaluation_gt_radius_label = QLabel('Ground truth radius [px]: ')
        self.evaluation_gt_radius_10_rbutton = QRadioButton('1.0')
        self.evaluation_gt_radius_15_rbutton = QRadioButton('1.5')
        self.evaluation_gt_radius_20_rbutton = QRadioButton('2.0')
        self.evaluation_gt_radius_30_rbutton = QRadioButton('3.0')

        evaluation_gt_radius_group = QButtonGroup(self)
        evaluation_gt_radius_group.addButton(self.evaluation_gt_radius_10_rbutton)
        evaluation_gt_radius_group.addButton(self.evaluation_gt_radius_15_rbutton)
        evaluation_gt_radius_group.addButton(self.evaluation_gt_radius_20_rbutton)
        evaluation_gt_radius_group.addButton(self.evaluation_gt_radius_30_rbutton)
        self.evaluation_gt_radius_20_rbutton.setChecked(True)
        self.evaluation_model_list = QListWidget()
        self.evaluation_model_list.setMinimumWidth(300)
        ...
        self.inference_menu.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
        ...
        self.inference_model_list.setMinimumWidth(300)
        ...
        self.inference_model_selection.setWindowFlags(Qt.WindowCloseButtonHint | Qt.WindowMaximizeButtonHint)
    ...
    def init_ui(self):
        ...
        # Settings box: Diameter selection layout
        diameter_selection_layout = QVBoxLayout()
        diameter_selection_layout.addWidget(self.diameter_selection_label)
        diameter_selection_rbutton_layout = QHBoxLayout()
        horizontal_spacer = QSpacerItem(12, 0, QSizePolicy.Minimum, QSizePolicy.Expanding)
        diameter_selection_rbutton_layout.addSpacerItem(horizontal_spacer)
        diameter_selection_rbutton_layout.addWidget(self.diameter_range_1_rbutton)
        diameter_selection_rbutton_layout.addWidget(self.diameter_range_2_rbutton)
        diameter_selection_rbutton_layout.addWidget(self.diameter_range_3_rbutton)
        diameter_selection_rbutton_layout.setAlignment(Qt.AlignLeft)
        diameter_selection_layout.addLayout(diameter_selection_rbutton_layout)
        ...
        settings_box_layout.addSpacerItem(QSpacerItem(0, 2, QSizePolicy.Minimum, QSizePolicy.Expanding))
        settings_box_layout.addLayout(diameter_selection_layout)
        settings_box_layout.addWidget(self.device_multi_gpu_checkbox)
        settings_box_layout.addSpacerItem(QSpacerItem(0, 4, QSizePolicy.Minimum, QSizePolicy.Expanding))
        ...
        import_data_layout.addWidget(self.import_data_resolution_checkbox)
        ...
        train_method_row1_layout = QHBoxLayout()
        train_method_row1_layout.addWidget(self.train_settings_method_1x1_rbutton)
        train_method_row1_layout.addWidget(self.train_settings_method_1x1_dilation_rbutton)
        train_method_row2_layout = QHBoxLayout()
        train_method_row2_layout.addWidget(self.train_settings_method_2x2_rbutton)
        train_method_row2_layout.addWidget(self.train_settings_method_2x2_dilation_rbutton)
        train_method_layout.addLayout(train_method_row1_layout)
        train_method_layout.addLayout(train_method_row2_layout)
        train_method_layout.addWidget(self.train_settings_method_3x3_rbutton)
        train_method_layout.setAlignment(Qt.AlignLeft)
        ...
        train_optimizer_layout.addSpacerItem(QSpacerItem(25, 0, QSizePolicy.Minimum, QSizePolicy.Minimum))
        ...
        evaluation_radius_layout = QHBoxLayout()
        evaluation_radius_layout.addWidget(self.evaluation_gt_radius_label)
        # evaluation_radius_layout.addSpacerItem(QSpacerItem(12, 0, QSizePolicy.Minimum, QSizePolicy.Expanding))
        evaluation_radius_layout.addWidget(self.evaluation_gt_radius_10_rbutton)
        evaluation_radius_layout.addWidget(self.evaluation_gt_radius_15_rbutton)
        evaluation_radius_layout.addWidget(self.evaluation_gt_radius_20_rbutton)
        evaluation_radius_layout.addWidget(self.evaluation_gt_radius_30_rbutton)
        evaluation_radius_layout.setAlignment(Qt.AlignLeft)
        evaluation_eval_layout.addLayout(evaluation_radius_layout)
        ...
        evaluation_eval_box.setSizePolicy(QSizePolicy.Minimum, QSizePolicy.Fixed)
    ...
    def closeEvent(self, event):
        ...
        if self.is_ready():
            ...
            self.message_box(title='Gui busy', text='Currently some calculations are done. Please stop the calculations'
                                                    ' first before closing BeadNet (with ctrl+c in the corresponding'
    ...
    def eval_menu_eval_button_clicked(self):
        ...
        # Get ground truth radius for metric calculation
        self.get_gt_radius()
        ...
        self.eval_thread.started.connect(partial(self.eval_worker.start_evaluation,
                                                 ...
                                                 f"Evaluate\n{print_message} on training set '{self.trainset}' with radius {self.gt_radius}"))
    ...
    def get_gt_radius(self):
        """ Get selected ground truth radius"""

        if self.evaluation_gt_radius_10_rbutton.isChecked():
            self.gt_radius = 1.0
        elif self.evaluation_gt_radius_15_rbutton.isChecked():
            self.gt_radius = 1.5
        elif self.evaluation_gt_radius_20_rbutton.isChecked():
            self.gt_radius = 2.0
        elif self.evaluation_gt_radius_30_rbutton.isChecked():
            self.gt_radius = 3.0
    ...
    def get_scale_factor(self):
        ...
        if self.diameter_range_1_rbutton.isChecked():
            self.scale_factor = 4
        elif self.diameter_range_2_rbutton.isChecked():
            self.scale_factor = 2
        elif self.diameter_range_3_rbutton.isChecked():
            self.scale_factor = 1
    ...
    def get_segmentation_method(self):
        ...
        """
        if self.train_settings_method_1x1_rbutton.isChecked():
            label_type = '1x1'
        elif self.train_settings_method_1x1_dilation_rbutton.isChecked():
            label_type = '1x1_dilation'
        elif self.train_settings_method_2x2_rbutton.isChecked():
            label_type = '2x2'
        elif self.train_settings_method_2x2_dilation_rbutton.isChecked():
            label_type = '2x2_dilation'
        elif self.train_settings_method_3x3_rbutton.isChecked():
            label_type = '3x3'
        else:
    ...
    def get_trained_models(self, scores_df):
        ...
        for model in models:
            if "{}: {}".format(model.parent.stem, model.stem) in scores_df.model.values:
                ...
                # Use maximum score for case it is evaluated for multiple radii
                trained_models.append(["{}: {} ({:.2f})".format(model.parent.stem,
                                                                model.stem,
                                                                max(model_row['average f-score'])),
                                       model,
                                       max(model_row['average f-score'])])
            else:
    ...
    def help_shortcut_clicked(self):
        ...
        text = 'File & training set selection:\n'\
               ...
               '   Diameter range: diameter range of the particles.\n' \
               '   Change group: change OMERO group.\n\n'\
               'Training data:\n'\
               '   Create crops: create crops from the selected files.\n'\
               '   Annotate: open OMERO.web for annotation.\n' \
               ...
               '   Ground truth radius: distance from center in which a prediction should be.'\
    ...
    def open_annotation_tool(self):
        ...
        annotation_tool_url = f"{self.annotation_tool_url}/webclient/?show=dataset-{self.trainset_id}"
    ...
    def train_data_crop_button_clicked(self):
        ...
        if self.crop_size == 0:
            self.message_box(title='Key Value Error',
                             text='No crop size of the selected training dataset found in the metadata. '
                                  ...
                                  'a key value pair (crop_size, value) or create a new training set with BeadNet.')
            self.disconnect()
            return
        ...
        for i, file_id in enumerate(self.file_ids):
            ...
            if img.getSizeX() * self.scale_factor < 0.9 * self.crop_size or img.getSizeY() * self.scale_factor < 0.9 * self.crop_size:
                continue
        ...
        if len(crop_list) == 0:
            self.output_edit.append('No supported files found. Check color channel. '
                                    'It can be the case that from each selected file/frame already crops have been'
                                    ' extracted.')
    ...
    def train_data_import_button_clicked(self):
        ...
        self.import_thread.started.connect(partial(self.import_worker.import_data,
                                                   ...
                                                   self.import_data_resolution_checkbox.isChecked(),
                                                   self.scale_factor,
                                                   self.crop_size,
                                                   self.trainset_id,
                                                   self.train_path,
