...
def build_unet(act_fun, pool_method, normalization, device, num_gpus, ch_in=1, ch_out=1, filters=(64, 512)):
    ...
    # Build model
    model = UNet(ch_in=ch_in, ch_out=ch_out, pool_method=pool_method, filters=filters, act_fun=act_fun,
